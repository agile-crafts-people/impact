...
The ``im`` Developer Edition script is how the SRE's provide a strong developer experience. 
...
## SRE Automation 
SRE Automation is done using the [stage0 runbooks](https://github.com/agile-learning-institute/stage0_runbooks) system. Our custom runbook is [runbook_api](https://github.com/agile-crafts-people/impact_runbook_api) which is available for use with ``de up runbook`` and accessing http://localhost and following the runbooks link. 
