...
delete-package: gh api -X DELETE /orgs//packages/container/impact'

launch-all: build-package publish-package
	@$(MAKE) launch-services SERVICES="$(ALL_SERVICES)"
